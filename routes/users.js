...
import { createHedonic, getHedonic } from "../controllers/createHedonic.js";
...
//create hedonic formulas endpoint
router.post("/createhedonic", authorizedRoutes, createHedonic)

//get Hedonic
router.get("/hedonic", authorizedRoutes, getHedonic);
